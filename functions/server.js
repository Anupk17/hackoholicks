...
if (require.main === module) {
  app.listen(PORT, () => {
    ...
    console.log('');
    if (!process.env.GROQ_API_KEY || process.env.GROQ_API_KEY.includes('PASTE')) {
      console.warn('⚠️  GROQ_API_KEY not set! Add your key to .env to enable AI features.');
    } else {
      console.log('✅ Groq AI key loaded.');
    }
    console.log('');
  });
}
